...
func (sq *ServiceQuery) QueryUserID() *UserQuery {
...
func (sq *ServiceQuery) Clone() *ServiceQuery {
	...
	return &ServiceQuery{
		...
		withUserID: sq.withUserID.Clone(),
...
func (sq *ServiceQuery) WithUserID(opts ...func(*UserQuery)) *ServiceQuery {
	query := (&UserClient{config: sq.config}).Query()
...
func (sq *ServiceQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Service, error) {
	...
	if query := sq.withUserID; query != nil {
		if err := sq.loadUserID(ctx, query, nodes, nil,
			func(n *Service, e *User) { n.Edges.UserID = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (sq *ServiceQuery) loadUserID(ctx context.Context, query *UserQuery, nodes []*Service, init func(*Service), assign func(*Service, *User)) error {
